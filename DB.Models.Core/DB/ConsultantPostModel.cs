...
{
	[Table("ConsultantPost", Schema = "dbo")]
	public partial class ConsultantPostModel : BaseModel
	{
		...
		[InverseProperty("ConsultantPost")]
		...
		[InverseProperty("ConsultantPost")]
		public virtual ICollection<ConsultantPostMediaModel> ConsultantPostMediaModels { get; set; }
